                ...
                <div class="view-box">
                    <form id="filter" class="form-horizontal" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2"><input id="startDate" name="startDate" placeholder="Start Date" class="form-control date-picker" type="text" ></div>
                            <label class="col-sm-2">To Date:</label>
                            <div class="col-sm-2"><input id="endDate" name="endDate" placeholder="End Date" class="form-control date-picker" type="text" ></div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2">From Time:</label>
                            <div class="col-sm-2"><input id="startTime" name="startTime" placeholder="Start Time" class="form-control time-picker" type="text" ></div>
                            <label class="col-sm-2">To Time:</label>
                            <div class="col-sm-2"><input id="endTime" name="endTime" placeholder="End Time" class="form-control time-picker" type="text" ></div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-8">
